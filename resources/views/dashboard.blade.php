<x-app-layout>
    ...
    <x-container class="py-6">
        <div class="grid md:grid-cols-8 gap-4">
            <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6 col-span-5">
            ...
            <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6 col-span-3">
                <div class="col-span-5">
                    <h3 class="text-xl leading-6 font-semibold tracking-tight text-gray-900 inline-flex">
                        <x-heroicon-o-chart-bar class="w-5 h-5 mr-1 text-green-600" /> Assets Divison
                    </h3>
                </div>
            </div>
        </div>
